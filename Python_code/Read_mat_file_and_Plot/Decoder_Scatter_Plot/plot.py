...
def read_my_result_1_for_y_scatter( my_model_name_for_y ):
    my_model_name = my_model_name_for_y
...
def drawing_with_makin( rEFH_dynamic_result, my_model_result, axis_type, kinematic_type , my_model_name_for_y):
...
drawing_with_makin(rEFH_x_pos, x_pos_1, 'x', 'pos',my_model_name_for_y)
drawing_with_makin(rEFH_y_pos, y_pos_1, 'y', 'pos',my_model_name_for_y)
drawing_with_makin(rEFH_x_vel, x_vel_1, 'x', 'vel',my_model_name_for_y)
drawing_with_makin(rEFH_y_vel, y_vel_1, 'y', 'vel',my_model_name_for_y)
drawing_with_makin(rEFH_x_acc, x_acc_1, 'x', 'acc',my_model_name_for_y)
drawing_with_makin(rEFH_y_acc, y_acc_1, 'y', 'acc',my_model_name_for_y)