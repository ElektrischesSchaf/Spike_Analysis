...
prediction_x_LN = pd.read_csv("layernorm/my_prediction_x_pos.csv", header=None)
prediction_x_LN = np.array(prediction_x_LN)

prediction_y_LN = pd.read_csv("layernorm/my_prediction_y_pos.csv", header=None)
prediction_y_LN = np.array(prediction_y_LN)

prediction_x_no_LN = pd.read_csv("no_layernorm/my_prediction_x_pos.csv", header=None)
prediction_x_no_LN = np.array(prediction_x_no_LN)

prediction_y_no_LN = pd.read_csv("no_layernorm/my_prediction_y_pos.csv", header=None)
prediction_y_no_LN = np.array(prediction_y_no_LN)
...
while(end_time_bin < int( prediction_y_no_LN.shape[0] )-duration ):
    ...
    plt.plot(prediction_x_LN[start_time_bin:end_time_bin], prediction_y_LN[start_time_bin:end_time_bin], color='blue', linewidth=5 , alpha=0.7, label='with LN')
    plt.plot(prediction_x_no_LN[start_time_bin:end_time_bin], prediction_y_no_LN[start_time_bin:end_time_bin], color='green', linewidth=5 , alpha=0.7, label='no LN')

    plt.scatter(x_ground_truth[start_time_bin], y_ground_truth[start_time_bin], color='black', marker='o', s=300)
    plt.scatter(prediction_x_LN[start_time_bin], prediction_y_LN[start_time_bin], color='blue' , marker='o', s=300)
    plt.scatter(prediction_x_no_LN[start_time_bin], prediction_y_no_LN[start_time_bin], color='green' , marker='o', s=300)

    plt.scatter(x_ground_truth[end_time_bin-1], y_ground_truth[end_time_bin-1], color='black', marker='X', s=300)
    plt.scatter(prediction_x_LN[end_time_bin-1], prediction_y_LN[end_time_bin-1], color='blue' , marker='X', s=300)
    plt.scatter(prediction_x_no_LN[end_time_bin-1], prediction_y_no_LN[end_time_bin-1], color='green' , marker='X', s=300)
    ...
    plt.savefig( trajectory_2D_path+ '/x_y_trajectory_with_LN'+ '_from_' + str( int(plotting_time_elapsed[start_time_bin,0]) )+'_to_'+str( int(plotting_time_elapsed[end_time_bin,0]) ) +'.png')
...
while(end_time_bin < int( prediction_y_no_LN.shape[0] )-duration ):
    ...
    plt.plot(plotting_time_elapsed[start_time_bin:end_time_bin], prediction_x_LN[start_time_bin:end_time_bin], color='blue', linewidth=5 , alpha=0.7, label='with LN')    
    plt.plot(plotting_time_elapsed[start_time_bin:end_time_bin], prediction_x_no_LN[start_time_bin:end_time_bin], color='green', linewidth=5 , alpha=0.7, label='no LN')    
    ...
    plt.plot(plotting_time_elapsed[start_time_bin:end_time_bin], prediction_y_LN[start_time_bin:end_time_bin], color='blue', linewidth=5 , alpha=0.7, label='with LN')    
    plt.plot(plotting_time_elapsed[start_time_bin:end_time_bin], prediction_y_no_LN[start_time_bin:end_time_bin], color='green', linewidth=5 , alpha=0.7, label='no LN')
