...
for my_estimator in range (1,31):
    ...
    if order_index==0:
        ...
        print('n_estimators=', str(my_estimator), end='  ')
        print('* model_x_position score in order ', order_index, ': ', r2_score( x_position_label_testing, x_position_predict ))
        print('\n', regr.score(X_for_training, x_position_label_training),'\n')
        ...
        print('\n',regr.score(X_for_training, y_position_label_training),'\n')
        ...
        print('\n',regr.score(X_for_training, z_position_label_training),'\n')
        ...
        print('\n',regr.score(X_for_training, y_velocity_label_training),'\n')
