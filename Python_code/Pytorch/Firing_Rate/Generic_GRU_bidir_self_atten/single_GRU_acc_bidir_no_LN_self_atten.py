...
from  Deep_Learning_Models.GRU_one_stream_self_Atten import GRUModel_bidir
...
model_name = 'GRU_Single_session_2_outputs_bidir_no_LN_self_atten'
MAX_EPOCH = 100
LEARNING_RATE = 1e-5
NUMBER_OF_LAYERS = 2
OUTPUT_DIM = 2
...
for session_k in range(len(session_file_list)):
    ...
    net = GRUModel_bidir(input_dim = feature_numbers, hidden_dim = hidden_dim, max_timestep = max_timestep, layer_dim = layer_dim, output_dim = output_dim, r=r)     # define the network    # print(net)  # net architecture
