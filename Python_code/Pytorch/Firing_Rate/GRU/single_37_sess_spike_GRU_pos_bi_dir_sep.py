...
from  Deep_Learning_Models.GRU_one_stream_self_Atten import GRUModel_bidir_separate
...
for session_k in range(len(session_file_list)):
    ...
    net = GRUModel_bidir_separate(input_dim=feature_numbers, hidden_dim=hidden_dim, max_timestep=max_timestep, layer_dim=layer_dim, output_dim=output_dim)     # define the network    # print(net)  # net architecture
