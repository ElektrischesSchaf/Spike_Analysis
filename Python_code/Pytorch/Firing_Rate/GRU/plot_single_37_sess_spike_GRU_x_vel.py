...
from  Deep_Learning_Models.GRU_one_stream_self_Atten_plot import GRUModel
...
for session_k in range(len(session_file_list)):
    ...
    for i, (x, testing_y) in trange:
        ...
        # attn_weight_matrix_all += [ attn_weight_matrix ]
        # attn_weight_matrix_all = torch.stack(attn_weight_matrix_all, 0)
