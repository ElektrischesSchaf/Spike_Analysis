...
from  Deep_Learning_Models.Generic_GRU_one_stream import BidirGRU
...
for session_k in range(len(session_file_list)):
    ...
    net = BidirGRU(input_dim = feature_numbers, hidden_dim = hidden_dim, max_timestep = max_timestep, layer_dim = layer_dim, output_dim = output_dim)     # define the network    # print(net)  # net architecture
