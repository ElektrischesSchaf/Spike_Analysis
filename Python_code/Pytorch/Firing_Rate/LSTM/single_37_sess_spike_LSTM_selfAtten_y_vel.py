...
# Deep leaning module
from  Deep_Learning_Models.LSTM_one_stream_selfAtten import LSTMModel
...
model_name='LSTM_selfAtten_with_Spike_Single_37_Session'
MAX_EPOCH=200
LEARNING_RATE=1e-5
NUMBER_OF_LAYERS=1
BATCH_SIZE=64
...
for session_k in range(len(session_file_list)):
    ...
    net = LSTMModel(input_dim=training_x.shape[1], batch_dim=batch_size, hidden_dim=hidden_dim, layer_dim=layer_dim, output_dim=output_dim)     # define the network
