...
from  Deep_Learning_Models.GRU_real_LN_two_Atten import Real_Layer_GRU_one_way_sequential_1
...
for session_k in range(len(session_file_list)):
    ...
    net = Real_Layer_GRU_one_way_sequential_1(input_dim = feature_numbers, hidden_dim = hidden_dim, max_timestep = max_timestep, layer_dim = layer_dim, output_dim = output_dim)     # define the network    # print(net)  # net architecture
