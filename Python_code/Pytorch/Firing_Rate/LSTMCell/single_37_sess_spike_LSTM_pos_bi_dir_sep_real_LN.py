...
from  Deep_Learning_Models.LSTM_real_LN_self_Atten import Real_Layer_LSTM_bidir_sep
...
for session_k in range(len(session_file_list)):
    ...
    net = Real_Layer_LSTM_bidir_sep(input_dim = feature_numbers, hidden_dim = hidden_dim, max_timestep = max_timestep, layer_dim = layer_dim, output_dim = output_dim)     # define the network    # print(net)  # net architecture
    ...
    def _run_iter(x,y):
        ...
        attn_weight_matrix_backward = attn_weight_matrix_backward.to(device)        
    ...
    while time_bin_index < (testing_data_length -plottin_duration_time_bin*2 ):
        Plotting.attention_map_2_outputs_bidir_sep_with_target_cue(session_name=session_name, type_name='pos', start_time_bin=time_bin_index, end_time_bin=time_bin_index+plottin_duration_time_bin, plot_path=attention_plot_path, my_prediction_1=my_prediction_1, Ground_Truth_1=Ground_Truth_1, my_prediction_2=my_prediction_2, Ground_Truth_2=Ground_Truth_2, attn_weight_matrix_all_forward=attn_weight_matrix_all[:,:max_timestep], attn_weight_matrix_all_backward=attn_weight_matrix_all[:,-max_timestep:], x_target_cue= x_target_all, y_target_cue=y_target_all, firing_rate_collector=firing_rate_collector)
