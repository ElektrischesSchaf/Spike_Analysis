...
from  Deep_Learning_Models.GRU_real_LN_self_Atten import Real_Layer_GRU_one_way_two_stream
...
for session_k in range(len(session_file_list)):
    ...
    net = Real_Layer_GRU_one_way_two_stream(input_dim = feature_numbers, hidden_dim = hidden_dim, max_timestep = max_timestep, layer_dim = layer_dim, output_dim = output_dim, sorted_unit_numbers=units_numbers_in_this_dataset)     # define the network    # print(net)  # net architecture
