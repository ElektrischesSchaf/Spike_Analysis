...
ax[1].plot(time_stamp_64ms[reduce_time_bin:reduce_time_bin*3], testing_y_1[reduce_time_bin:reduce_time_bin*3], 'b--', linewidth=3, label='x-coordinate', alpha=1 )
ax[1].plot(time_stamp_64ms[reduce_time_bin:reduce_time_bin*3], testing_y_2[reduce_time_bin:reduce_time_bin*3], 'g--', linewidth=3, label='y-coordinate', alpha=1 )
