...
for session_k in range(len(session_file_list)):
    ...
    # print('itpc_testing_data_index= ',itpc_testing_data_index)
    itpc_testing_data_index=5000
    ...
    new_training_x_before_PoF=new_training_x_before_PoF.numpy()
    new_training_x_after_PoF=new_training_x_after_PoF.numpy()
    ...
    new_training_x_before_PoF=np.transpose(new_training_x_before_PoF)
    ...
    for i in range(96):
        # yee=yee+gcmi.gcmi_cc(  new_training_x[i,:] , training_y )
        yee=gcmi.gcmi_cc(  new_training_x_after_PoF[i,:] , training_y ) # TODO
        mi_of_all_channels_after_PoF.append(yee)
    # print('average new_training_x vs training_y = ', yee/96, '\n')
...
plt.bar(ind-width_two-width_two, average_spike_all_sessions, width=width_two, color='r')
