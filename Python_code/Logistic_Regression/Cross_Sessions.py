...
if order_index >=2:
    ...
    model_x_position = LogisticRegression(fit_intercept=True)
    ...
    model_y_position = LogisticRegression(fit_intercept=True)
    ...
    model_z_position = LogisticRegression(fit_intercept=True)
    ...
    model_x_velocity=LogisticRegression(fit_intercept=True)
    ...
    model_y_velocity=LogisticRegression(fit_intercept=True)
    ...
    model_z_velocity=LogisticRegression(fit_intercept=True)
    ...
    model_x_acceleration = LogisticRegression(fit_intercept=True)
    ...
    model_y_acceleration = LogisticRegression(fit_intercept=True)
    ...
    model_z_acceleration = LogisticRegression(fit_intercept=True)
