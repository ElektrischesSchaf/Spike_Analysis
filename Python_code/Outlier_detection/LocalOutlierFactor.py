...
LOF_score_array=clf.fit_predict(X_for_training)
print('LocalOutlierFactor This is session '+file_list[file_numbers], ' training data \n')
print('with_sorted_spikes = '+str(with_sorted_spikes))

print(LOF_score_array,'\n')
print(collections.Counter(LOF_score_array))

# Outliers in testing data
clf=LocalOutlierFactor(n_neighbors=2)
LOF_score_array=clf.fit_predict(X_for_prediction)
print('LocalOutlierFactor This is session '+file_list[file_numbers], ' testing data \n')
print('with_sorted_spikes = '+str(with_sorted_spikes))
print(LOF_score_array,'\n')
print(collections.Counter(LOF_score_array))