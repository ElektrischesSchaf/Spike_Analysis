...
IsoForest_array=clf.fit_predict(X_for_training)
print('IsolationForest This is session '+file_list[file_numbers], ' training data \n')
print('with_sorted_spikes = '+str(with_sorted_spikes))
print(IsoForest_array,'\n')
print(collections.Counter(IsoForest_array))

# Outliers in testing data
clf = IsolationForest(random_state=0)
IsoForest_array=clf.fit_predict(X_for_prediction)
print('IsolationForest This is session '+file_list[file_numbers], ' testing data \n')
print('with_sorted_spikes = '+str(with_sorted_spikes))
print(IsoForest_array,'\n')
print(collections.Counter(IsoForest_array))