...
for my_estimators in range (100,105,5):
    ...
    if order_index==0:
        ...
        #plot.show()
        plot.savefig('random_forest_x_velocity_predict.png' )
        ...
        axes.set_xlim([740, 760])
        #plot.show()
        plot.savefig('random_forest_y_velocity_predict.png' )
        ...
        axes.set_xlim([740, 760])
        #plot.show()
        plot.savefig('random_forest_x_acceleration_predict.png' )
        ...
        axes.set_xlim([740, 760])
        #plot.show()
        plot.savefig('random_forest_y_acceleration_predict.png' )
