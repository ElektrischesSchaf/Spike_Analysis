...
for i in range(100):
    ...
    my_plot_width=29
    my_plot_height=7
    figure_path='../../../Figures/Raw_data_and_Spike/instantaneous_phase/heatmap_3-8Hz/'
    my_fontsize=30
    ...
    # for channel_number_yee in good_channel_list_start_from_one:
        ...
        filtered_data_1=butter_highpass_filter(channel_1, band_start, sampling_rate, order=3)
        filtered_data_1=butter_lowpass_filter(filtered_data_1, band_cutoff, sampling_rate, order=3)
