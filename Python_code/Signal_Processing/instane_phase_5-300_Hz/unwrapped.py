...
for i in range(3):
    ...
    plt.subplot(411)
    filter_data=butter_bandpass_filter(new_data,5,300,sampling_rate, order=3)
    plt.scatter(new_nwb_time_stamp, filter_data, s=1, color= 'black')
    ...
    filtered_data=butter_bandpass_filter(new_data,5, 300, sampling_rate, order=3)
    ...
    plt.ylabel('Unwrapped Phase', fontsize=10, color="black")
