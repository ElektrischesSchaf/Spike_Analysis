...
for i in range(100):
    ...
    my_plot_width=29
    my_plot_height=7
    figure_path='../../../Figures/Raw_data_and_Spike/instantaneous_phase/heatmap_0-40Hz/'
    my_fontsize=30
    ...
    spike_signal=butter_bandpass_filter(channel_1, 500, 5000, sampling_rate, order=3)
    ...
    for channel_number_yee in range(96):
        ...
        # filtered_data_1=butter_bandpass_filter(channel_1, band_start, band_cutoff, sampling_rate, order=2) # order more than 3 doesn't work in 0.5-40
        filtered_data_1=butter_lowpass_filter(channel_1, band_cutoff, sampling_rate, order=2)
    ...
    if kinematic_variable_type=='vel':
        plt.savefig(figure_path+'instantaneous-phase-heatmap_vs_velocity_on_all_channel_from_'+ str(start_second)  +'_to_'+str(end_second) + '.png')
